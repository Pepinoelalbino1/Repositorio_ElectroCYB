      ...
      {isLoaded && (
        <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
          <p className="text-sm text-green-700">
            ✅ Se han cargado {sampleOrders.length} pedidos de ejemplo de ElectroCYB. 
            Puedes probar el tracking con los siguientes IDs:
          </p>
          ...
          <div className="mt-3 text-xs text-green-600">
            <strong>Productos incluidos:</strong> Lámparas LED, Tiras LED RGB, Focos LED, 
            Fuentes de poder, Kit Solar, Detector de billetes, Extensiones, Mangueras LED, etc.
          </div>
        </div>
      )}
    </div>
